...
function drawEndSequence() {
  ...
  textSize(32);
  textStyle(BOLD);
  text("SLAUGHTER HOUSE", width / 2, height / 2 - 300);
  image(img, width/2-125, height/2-280, 250, 250);
  textStyle(NORMAL);
  text("by SEMATARY", width / 2, height / 2 - 10);
