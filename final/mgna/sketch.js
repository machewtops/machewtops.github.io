...
function drawEndSequence() {
  ...
  textSize(32);
  textStyle(BOLD);
  text("$ome Drugzzz", width / 2, height / 2 - 300);
  image(img, width/2-125, height/2-280, 250, 250);
  textStyle(NORMAL);
  text("by MGNA Crrrta", width / 2, height / 2 - 10);
